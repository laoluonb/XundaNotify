...
function render() {
  ...
  app.innerHTML = `<div class="shell">
    ...
    <main class="content"><div class="topbar"><div class="topbar-spacer"></div><button class="tool" id="check-update-top" title="检查更新">↻</button><button class="tool version-tool ${updateState.status === "available" ? "update-tool" : ""}" title="当前版本">v${CURRENT_VERSION}</button></div>${active === "overview" ? overview() : active === "history" ? history() : active === "settings" ? settings() : active === "about" ? about() : logs()}</main>
  </div>`;
